            ...
            <TabsContent value="signup">
              <form onSubmit={handleSignUp} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="signup-phone" type="tel" placeholder="(71) 00000-0000" value={phone} onChange={e => setPhone(e.target.value)} required />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input id="new-user-password" type={showNewUserPassword ? "text" : "password"} placeholder="Digite sua senha" value={newUserPassword} onChange={e => setNewUserPassword(e.target.value)} required className="pr-10" />
                    <button type="button" onClick={() => setShowNewUserPassword(!showNewUserPassword)} className="absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground transition-colors">
